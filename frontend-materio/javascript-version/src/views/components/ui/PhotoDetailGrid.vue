    ...
    <div class="panel">
        ...
        <div class="table-responsive">
            ...
            <v-table v-if="!editMode">
                ...
                <tbody>
                    <tr v-for="(detailVal, idx) in selectedRow.photos" :key="detailVal" >
                        <td class="font-semibold">{{ idx + 1 }}</td>
                        <td class="whitespace-nowrap">{{ detailVal.imgFile }}</td>
            ...
            <v-table v-else>
                ...
                <tbody>
                    <tr v-for="(addVal, idx) in newValue" :key="addVal" >
                        <td class="font-semibold">{{ idx + 1 }}</td>
                        <td class="whitespace-nowrap">
                            <LargeObject style="margin-left: -5px; width: 150px;" :editMode="editMode" v-model="addVal.imgFile"/>
                        </td>
                    </tr>
                </tbody>
            </v-table>
